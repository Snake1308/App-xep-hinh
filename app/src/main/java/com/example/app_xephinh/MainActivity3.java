...
public class MainActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        billingClient = BillingClient.newBuilder(MainActivity3.this)
    ...
    private void getProductDetails(){
        QueryProductDetailsParams queryProductDetailsParams = QueryProductDetailsParams.newBuilder().setProductList(
                ImmutableList.of(QueryProductDetailsParams.Product.newBuilder()
                        .setProductId("free_image_animal_3_day")
                ...
                queryProductDetailsParams, new ProductDetailsResponseListener() {
                    ...
                    public void onProductDetailsResponse(@NonNull BillingResult billingResult, @NonNull List<ProductDetails> list) {
                        ...
                        if (!list.isEmpty()) {
                            ...
                            Button btn_buy = findViewById(R.id.btn3);
                            prD = list.get(0);
...
//                                    activity.setIntent(new Intent());
                                    billingClient.launchBillingFlow(MainActivity3.this, billingFlowParams);
                                }
                            });
                        }
//                        }else {
